...
export function ensureZooms(db, info) {
...
export function ensureBounds(db, info) {
...
export function ensureCenter(info) {
 ...
 * @returns headers
 */
export function headersFromMetadata(info, lastModified) {
...
export function headersFromTile(tile, lastModified) {
  return {

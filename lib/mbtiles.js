...
export default function mbTiles(filename) {
  ...
  function prepareGetTile() {
    if (process.env.MBTILES_PRAGMA) {
      my.db.exec(process.env.MBTILES_PRAGMA);
    }
    return my.db.prepare(
